                      ...
                      <div class="content">
                                ...
                                <div class="sidebar-div chat-body"
                                  ...
                                  <ul class="user-list space-chat">
                                    <li class="user-list-item chat-user-list"
                                        v-for="(course, index) in enrollCourses" :key="index"
                        ...
                        <div class="chat chat-messages" id="middle">
                          <div class="h-100">
                            ...
                            <!-- Chat header -->
                            <div class="chat-header" v-if="enrollCourse != null">
                              <div class="user-details mb-0">
                                <figure class="avatar mb-0">
                                  <img :src="enrollCourse != null ? enrollCourse.coverImage : null">
                                </figure>
                                <div class="mt-1">
                                  <h5>{{ enrollCourse.title }}</h5>
                                </div>
                              </div>
...
export default {
  ...
  methods: {
    ...
    getEnrollCourse(){
      baseApi.get(`/messages/getEnrollCourse/${this.user.id}`)
      .then( courses => {
        this.enrollCourses = courses.data
          ...
          this.stompClient.subscribe("/topic/messages", (message) => {
            try {
              ...
              if (this.messages != null) {
                ...
                } if (messageData.idCourse == this.enrollCourse.id){
