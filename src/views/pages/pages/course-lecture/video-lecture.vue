<template>
    <div v-if="lecture?.type === 'video'">
        <!-- Video -->
        <div>
            <video v-if="lecture && lecture.videos && lecture.videos.length > 0"
                :src="lecture.videos[0].videoUrl" controls
            ...
            <div class="instructor-wrap hoverComment"
                ...
                <div style=" margin: 0; display: flex; justify-content: space-between; flex-wrap: nowrap; flex-grow: 1;">
                    <div class="instructor-detail" style="width: 100%">
                        ...
                        <p style="font-size: 16px; margin: 5px 0 0 0; white-space: normal; overflow-wrap: break-word; word-break: break-word;">{{ commentParent.commentText }}</p>
                        <!-- Post reply -->
                        <a href="javascript:;"
                        ...
                        <ul style="margin: 15px 0 0 35px">
                            ...
                            <div class="instructor-wrap hoverReply"
                                ...
                                <div class="instructor-detail" style="width: 100%">
                                    ...
                                    <p style=" font-size: 16px; margin: 5px 0 0 0; white-space: normal; overflow-wrap: break-word; word-break: break-word; padding-right: 20px;">{{ commentChild.commentText }}</p>
                                    <!-- Edit reply -->
                                    <!-- Edit reply -->
                                    <!-- Post reply to reply-->
                                    <!-- Post reply to reply-->
